...
\begin{center}
	\includegraphics[scale=0.2]{tailToTailNoGiven}
\end{center}
...
\]
The tail-to-tail case says that $a$ and $b$ are \textit{not independent}, written %TODO non so come scrivere quel simbolo $a\downmodels b\vert\emptyset$ 
if $c$ is not given:
\[
...
\] 
\begin{center}
	\includegraphics[scale=0.2]{tailToTailGiven}
\end{center}
...
\begin{minipage}[htp]{\linewidth}
	\begin{minipage}[t]{0.48\linewidth}
		\begin{center}
			\includegraphics[width=\linewidth]{tailToTailExample1}
		\end{center}
	...
	\begin{minipage}[t]{0.48\linewidth}
		\begin{center}
			\includegraphics[width=\linewidth]{tailToTailExample2}
		\end{center}
...
\begin{center}
	\includegraphics[scale=0.2]{HeadToTailNoGiven}
\end{center}
